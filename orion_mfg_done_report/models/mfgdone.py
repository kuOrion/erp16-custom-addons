...
#         mfg_orders = self.env['mrp.production'].search([
#             ('state', '=', 'done'),
...
#             'report_name': 'orion_mfg_done_report.py3o_mfgdone',
#             'model': 'mfgdone',
#             'report_type': 'py3o',
#         }
#
...
#             'view_mode': 'tree',
#             'views': [(self.env.ref('orion_mfg_done_report.view_mfg_done_tree').id, 'tree')],
#             'target': 'self',
#         }
#
...
class MrpProduction(models.Model):
    ...
    def _compute_partner_id(self):
        for record in self:
            ...
            if record.origin and 'SO' in record.origin:
