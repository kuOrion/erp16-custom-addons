...
class HrPayslipLine(models.Model):
    ...
    def _get_partner_id(self, credit_account):
        ...
        if credit_account:
            if register_partner_id or self.salary_rule_id.account_credit.account_type in ('receivable', 'payable'):
                return partner_id
        else:
            if register_partner_id or self.salary_rule_id.account_debit.account_type in ('receivable', 'payable'):
                return partner_id
        return False
